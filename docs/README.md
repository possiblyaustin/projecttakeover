...
| [muse-encounter-design_v1.md](muse-encounter-design_v1.md) | **[DRAFT]** | MUSE encounter design (first Act 2 model): discovery via buried WaveCrowd posts, the CREATE/DIRECT/REFLECT creative-dialogue mechanic, rapport/intrusion state arcs, scripted Allied/Controlled flips. Also the QUILL first-contact revision (QUILL pings the player via Uplink). Build pending. |
| [muse-content-package_v1.md](muse-content-package_v1.md) | **[DRAFT]** | MUSE content: ~420-token persona prompt, 8 disposition state blocks, QUILL→WaveCrowd bridge DM (2 variants), HELPYR pop-ups, the WaveCrowd page (header/sidebar/6 normal + 4 buried posts), MUSE stalling lines (5×5 tiers), 8-entry recovery pool, first-contact scripted opening. Build pending. |
